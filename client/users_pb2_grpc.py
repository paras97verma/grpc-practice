...
class UsersStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetUserById = channel.unary_unary(
                ...
                response_deserializer=users__pb2.GetUserByIdReponse.FromString,
                )
...
def add_UsersServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetUserById': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=users__pb2.GetUserByIdReponse.SerializeToString,
            ),
...
class Users(object):
    ...
    def GetUserById(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/users.Users/GetUserById',
            ...
            users__pb2.GetUserByIdReponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
